...
const AI_POST_ASSETS = {
  diary: {
    ...
    sticker: ['pello/pello-basic.png', 'pello/pello-diary.png', 'pello/pello-cloud.png', 'pello/pello-sleepy.png', 'pello/pello-cheer.png', 'potion-charm.png', 'cloud-soft.png', 'memo-card.png', 'bow-heart.png']
  },
  trend: {
    ...
    sticker: ['study-laptop.png', 'study-book.png', 'memo-card.png', 'gold-star.png']
  }
};
...
function assetMarkdown(file, alt) {
  const safeFile = String(file || '').replace(/[^a-z0-9._-]/gi, '');
  if (!safeFile) return '';
